...
<head>
  <meta charset="utf-8" />
  <title>Editar Noticias - Formoid contact form html</title>
...
<?echo form_open_multipart('welcome/upload_editar')?><div enctype="multipart/form-data" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:800px;min-width:150px" method="post"><div class="title"><h2>Crear Noticias</h2></div>
  ...
  <div class="element-file"><label class="title"></label><div class="item-cont"><label class="large" ><div class="button">Selecciona Imagen</div><input type="file" class="file_input" name="userfile" required="required"  /><div class="file_text">Selecciona imagen</div><span class="icon-place"></span></label></div></div>
