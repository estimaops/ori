    ...
    <div class="container">
                ...
                if($i>($dat-1)*6 and $i<($dat*6)+1){
                    ...
                    echo "
                        ...
                        <div class='col-md-4 portfolio-item'>
                            ...
                            <h3>
                                <a href=";?><?php echo base_url() ?><?php echo "index.php/welcome/pag5/$i>$noticia->TITULO $i</a>
                            </h3>
                            <p>$noticia->CUERPO</p>
                        </div>
                    ";
        ...
        for ($j=0; $j < ($i-1)/6 ; $j++) { 
                ...
                echo "
                            ...
                            <li class='active'>
                                <a href=";?><?php echo base_url() ?><?php echo "index.php/welcome/pag4/$numerop>$numerop</a>
                            </li>
